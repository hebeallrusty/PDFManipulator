...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.5 on Wed Apr  8 20:01:59 2020
#
...
class Frame_PDFManipulator(wx.Frame):
    ...
    def Event_Button_Split_InputFile(self, event):  # wxGlade: Frame_PDFManipulator.<event_handler>
        ...
        #wx.FileSelector("Choose PDF File",default_extension=".pdf",wildcard="PDF files (*.pdf)|*.pdf")
        event.Skip()
